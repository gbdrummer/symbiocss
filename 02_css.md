...
Our global styles go at the top of the stylesheet and will be applied to all elements of the same type across the board. Our "component-scoped" css receives the global styles thanks to the Cascade, and then applies additional styles to the blog component while leaving the global styles untouched. 
